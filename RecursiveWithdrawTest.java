...
public class RecursiveWithdrawTest {
	...
	public static Scanner scanline;
	...
	public void test107_89_67_45_23_12_7_4withdraw_150() {
		...
		assertNotNull(valuable);
		String[] answer = new String[] { "89 45 12 4", "45 89 12 4",
				"12 89 45 4", "4 89 45 12", "4 12 45 89" };
		assertTrue(check(answer, convertToString(valuable)));
	...
	public void test245_86_77_53_46_34_28_12_9_5_3_1withdraw_300() {
		...
		System.out
				.println("Test: test245_86_77_53_46_34_28_12_9_5_3_1withdraw_300");
		System.out.println("Your answer: " + convertToString(valuable));
		System.out
				.println("Expected answer should contains:[86 77 53 46 34 3 1], [9 46 245],[5 34 12 28 9 46 86 77 3],[245 34 12 9],[3 5 9 12 28 34 46 77 86"
	...
	public void test3_77_86_53_46_9_28_12_34_5_245_1withdraw_300() {
		...
		Valuable[] valuable = purse.withdraw(300);
		System.out
				.println("Test: test3_77_86_53_46_9_28_12_34_5_245_1withdraw_300");
		System.out.println("Your answer: " + convertToString(valuable));
		System.out
				.println("Expected answer should contains:[86 77 53 46 34 3 1], [9 46 245],[5 34 12 28 9 46 86 77 3],[3 5 9 12 28 34 46 77 86] There are many solution\n");
		assertNotNull(valuable);
		String[] answer = new String[] { "86 77 53 46 34 3 1", "9 46 245",
				"5 34 12 28 9 46 86 77 3", "86 77 46 34 28 12 9 5 3",
				"3 5 9 12 28 34 46 77 86" };
		assertTrue(check(answer, convertToString(valuable)));
		assertTrue(checkByAdding(valuable, 300));
	}
	...
	public void Test41_61_25_37_607_758_41056_42_45_245_887_452_23_1022_1054_1024_1111_75_83_454_251_451_458_withdraw_5214() {
		...
		System.out
				.println("Test: test41_61_25_37_607_758_41056_42_45_245_887_452_23_1022_1054_1024_1111_75_83_454_251_451_458_withdraw_5214");
		System.out.println("Your answer: " + convertToString(valuable));
		System.out
				.println("Expected answer should contains:[1111 1054 758 458 454 451 251 245 83 75 61 45 42 41 37 25 23] There are many solution\n");
		assertNotNull(valuable);
	...
	public void Test41_37_607_245_887_452_1054_1024_75_83_251_458_withdraw_5214() {
		...
		Valuable[] valuable = purse.withdraw(5214);
		System.out
				.println("Test: hardcoreTest41_37_607_245_887_452_1054_1024_75_83_251_458_withdraw_5214");
		System.out.println("Your answer: " + convertToString(valuable));
		System.out
				.println("Expected answer should contains:[1054 1024 887 607 458 452 251 245 83 75 41 37] There are many solution\n");
	...
	public void test41_61_25_37_607_758_4156_42_45_245_887_452_23_1022_1054_1024_1111_75_83_454_251_451_458_withdraw_5214() {
		...
		Valuable[] valuable = purse.withdraw(5214);
		System.out
				.println("Test: test41_61_25_37_607_758_4156_42_45_245_887_452_23_1022_1054_1024_1111_75_83_454_251_451_458_withdraw_5214");
		System.out.println(valuable == null);
		System.out.println("Your answer: " + convertToString(valuable));
		System.out
				.println("Expected answer should contains: [245 42 4156 607 37 25 61 41],[4156 607 245 61 42 41 37 25],[25 37 41 42 61 245 607 4156] There are many solution\n");
		assertNotNull(valuable);
		assertTrue(checkByAdding(valuable, 5214));
	}
		...
		while (scanline.hasNext()) {
			...
			if (scanline.hasNextDouble()) {
				...
				if (value < 20)
					...
					money = new BankNote((double) value);
			}
			purse.insert(money);
		}
		return purse;
